...
export class PouchdbService {
  ...
  public deleteAll(): Promise<void> {
    ...
    //  CLEANUP
    const promise = new PouchDB('tmp-pouchdb-walletudg').destroy()
      .then(() => Promise.resolve(new PouchDB('pouchdb-walletudg')))
      ...
      .then((tmpDB) => new Promise((resolve, reject) => {
        try {
          resolve({ db: new PouchDB('pouchdb-walletudg'), tmpDB });
        } catch (e) {
          reject(e);
        }
      }))
